...
const mockData = {
  ...
  classrooms: [
    ...
    },
    {
      ...
      floor: 3,
      building: "Главный корпус",
      equipment: ["компьютеры", "проектор", "лабораторное оборудование"],
      available: true
    },
    {
      id: 4,
      ...
      floor: 4,
      building: "Главный корпус",
      equipment: ["проектор", "система видеоконференцсвязи", "флипчарт"],
      available: true
    },
    {
      id: 5,
      ...
      floor: 2,
      building: "Главный корпус",
      equipment: ["телевизор", "доска", "стол для переговоров"],
      available: true
    },
    {
      id: 6,
      number: "Конференц-зал А",
      type: "conference",
      capacity: 100,
      floor: 1,
      building: "Главный корпус",
      equipment: ["проектор", "микрофоны", "сцена", "звуковая система"],
      available: true
    },
    {
      id: 7,
      ...
      equipment: ["спортивный инвентарь", "раздевалки", "душ"],
      available: true
    },
    {
      id: 8,
      ...
      floor: 1,
      building: "Главный корпус",
      equipment: ["сцена", "звуковая система", "освещение", "проектор"],
      available: true
    }
  ],
